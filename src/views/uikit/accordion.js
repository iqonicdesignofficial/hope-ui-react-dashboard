            ...
            <article id="accordion">
                ...
                <Card className="iq-document-card iq-doc-head">
                    <Tab.Container defaultActiveKey="first">
                        <div className="d-flex justify-content-end ">
                            <Nav as="ul" className="nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className="d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-accordion-prv" type="button" role="tab" aria-controls="output" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="second" className="d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-accordion-code" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tab.Content>
                            <Tab.Pane eventKey="first" className="fade show bd-heading-1" id="content-accordion-prv" role="tabpanel" aria-labelledby="typo-output">
                            ...
                            <Tab.Pane eventKey="second" className="bd-heading-1 fade show" id="content-accordion-code" role="tabpanel" aria-labelledby="typo-output">
