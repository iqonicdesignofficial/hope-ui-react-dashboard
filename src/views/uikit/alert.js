                        ...
                        <div className="d-flex justify-content-end">
                            <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" >
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link as="button" eventKey="first" className={toggleState === 1 ? "tabs active bg-primary" : "tabs d-flex align-items-center"} onClick={() => toggleTab(1)} data-bs-toggle="tab" data-bs-target="#content-accordion-prv" type="button" role="tab" aria-controls="output" aria-selected="false">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Nav.Item as="li" role="presentation">
                                    <Nav.Link  eventKey="second" as="button" className={toggleState === 2 ? "tabs active-tabs bg-primary" : "tabs d-flex align-items-center"} onClick={() => toggleTab(2)} data-bs-toggle="tab" data-bs-target="#content-accordion-code" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
