                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div className="d-flex align-items-center flex-wrap">
                                    <Dropdown className=" me-3">
                                        <Dropdown.Toggle as="span" className=" align-items-center d-flex" id="dropdownMenuButton04" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Sort By:
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu className=" dropdown-menu-end" aria-labelledby="dropdownMenuButton04">
                                            <Dropdown.Item className="" href="#">Status</Dropdown.Item>
                                            <Dropdown.Item className="" href="#">Task Name</Dropdown.Item>
                                            <Dropdown.Item className="" href="#">Priority</Dropdown.Item> 
                                            <Dropdown.Item className="" href="#">Assignee</Dropdown.Item>
                                            <Dropdown.Item className="" href="#">Due date</Dropdown.Item>
                                            <Dropdown.Item className="" href="#">Start date</Dropdown.Item>
                                            <Dropdown.Item className="" href="#">Time tracked</Dropdown.Item> 
                                        </Dropdown.Menu>
                                    </Dropdown>
                                    <Dropdown className=" me-3">
                                        <Dropdown.Toggle as="span" className=" align-items-center d-flex" id="dropdownMenuButton05" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Group By: Status 
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu  className="dropdown-menu-end" aria-labelledby="dropdownMenuButton05" >
                                    ...
                                    <Dropdown className="">
                                        <Dropdown.Toggle as="span" className=" align-items-center d-flex" id="dropdownMenuButton06" role="button" data-bs-toggle="dropdown" aria-expanded="false"></Dropdown.Toggle>
                                        <Dropdown.Menu className="dropdown-menu-end" aria-labelledby="dropdownMenuButton06">
                                            <Dropdown.Item className="" href="#">
                                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="me-2">
                               ...
                               <div className="group1-wrap">
                                    <div className="group" id="group1">
                                        <Col lg="12" className=" group__item">
                                            <ReactSortable list={state1} group={{
                                                name: "group1",
                                                put: ["group1","group2", "group3", "group4"]
                                            }} pull={true} animation={200} delayOnTouchStart={true} delay={2} setList={setState1}>
                                            {state1.map((item) => (
                            ...
                            <Row>
                                ...
                                <div className="group2-wrap">
                                    <div className="group" id="group2">
                                        <Col lg="12" className=" group__item">
                                            <ReactSortable list={state2} group={{
                                                name: "group2",
                                                put: ["group1","group2", "group3", "group4"]
                                            }} pull={true} animation={200} delayOnTouchStart={true} delay={2} setList={setState2}>
                                            {state2.map((item) => (
                                                <Card className=""   key={item.id}>
                                                    <Card.Body className="">
                                                        <div className="d-grid grid-flow-col align-items-center justify-content-between mb-2">
                            ...
                            <Row className="">
                                ...
                                <div className="group3-wrap">
                                    <div className="group" id="group3">
                                        <Col lg="12" className=" group__item">
                                            <ReactSortable list={state3} group={{
                                                name: "group3",
                                                put: ["group1","group2", "group3", "group4"]
                                            }} pull={true} animation={200} delayOnTouchStart={true} delay={2} setList={setState3}>
                                            {state3.map((item) => (
                            ...
                            <Row>
                                ...
                                <div className="group4-wrap">
                                    <div className="group" id="group4">
                                        <Col lg="12" className=" group__item">
                                            <ReactSortable list={state4} group="group4" put={["group2","group3","group1"]} pull={true} animation={200} delayOnTouchStart={true} delay={2} setList={setState4}>
                                            {state4.map((item) => (
